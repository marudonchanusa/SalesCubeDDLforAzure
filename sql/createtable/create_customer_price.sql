...
INSERT INTO CUSTOMER_RETAIL_PRICE_HIST_XXXXX(HIST_ID,ACTION_TYPE,ACTION_FUNC,REC_DATETM,REC_USER,APPLY_DATE,CUSTOMER_CODE,PRODUCT_CODE,RETAIL_PRICE,CRE_FUNC,CRE_DATETM,CRE_USER,UPD_FUNC,UPD_DATETM,UPD_USER,DEL_FUNC,DEL_DATETM,DEL_USER) VALUES ( histId, 'INSERT', NEW.CRE_FUNC, now(), NEW.CRE_USER, NEW.APPLY_DATE, NEW.CUSTOMER_CODE, NEW.PRODUCT_CODE, NEW.RETAIL_PRICE, NEW.CRE_FUNC, NEW.CRE_DATETM, NEW.CRE_USER, NEW.UPD_FUNC, NEW.UPD_DATETM, NEW.UPD_USER, NEW.DEL_FUNC, NEW.DEL_DATETM, NEW.DEL_USER);
END IF;
...
INSERT INTO CUSTOMER_RETAIL_PRICE_HIST_XXXXX(HIST_ID,ACTION_TYPE,ACTION_FUNC,REC_DATETM,REC_USER,APPLY_DATE,CUSTOMER_CODE,PRODUCT_CODE,RETAIL_PRICE,CRE_FUNC,CRE_DATETM,CRE_USER,UPD_FUNC,UPD_DATETM,UPD_USER) VALUES ( histId, 'UPDATE', NEW.CRE_FUNC, now(), NEW.CRE_USER, NEW.APPLY_DATE, NEW.CUSTOMER_CODE, NEW.PRODUCT_CODE, NEW.RETAIL_PRICE, NEW.CRE_FUNC, NEW.CRE_DATETM, NEW.CRE_USER, NEW.UPD_FUNC, NEW.UPD_DATETM, NEW.UPD_USER, NEW.DEL_FUNC, NEW.DEL_DATETM, NEW.DEL_USER);
END IF;
...
CREATE INDEX CUSTOMER_PRODUCT_CODE ON CUSTOMER_RETAIL_PRICE_XXXXX(APPLY_DATE,CUSTOMER_CODE,PRODUCT_CODE);